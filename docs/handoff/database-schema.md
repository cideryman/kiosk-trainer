...
| 6 | `게스트프로필` | A1:D9 | 4 | 저장 동의한 카카오 표시명·배송지 |
| 7 | `후기내역` | A1:L69 | 12 | 후기, 사진, 공개 상태, 관리자 답글, 수정 이력 |
| 8 | `운영설정` | A1:B32 | 2 | 배달왔삼 영업 상태와 운영 값 |
| 9 | `관리자로그` | A1:H1971 | 8 | 관리자 변경 이력 |
| 10 | `이용자목록` | A1:E13 | 5 | 일반 키오스크 이용자와 크레딧 |
| 11 | `주문내역` | A1:X313 | 24 | 현재 주문 원장과 커밋 상태 |
| 12 | `주문보관` | A1:W531 | 23 | 지난 주문 아카이브. `commitStatus`는 아직 없음 |
| 13 | `설정` | A1 | 1 | 현재 비어 있는 미사용 시트 |
| 14 | `주문보관_자동백업_20260711_100325` | A1:W492 | 23 | 주문보관 실행 시 생성된 자동 백업 스냅샷 |
| 15 | `주문보관_자동백업_20260720_171326` | A1:W492 | 23 | 주문보관 실행 시 생성된 자동 백업 스냅샷 |
