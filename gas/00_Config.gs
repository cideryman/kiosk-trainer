...
const API_CONTRACT_VERSION = '2026-08-24.1';
...
const ADMIN_ACTIONS = [
  ...
  'getKitchenDashboard',
  'getAdminOrdersToday',
  'getDeliveryPlaceAliases',
  'updateDeliveryPlaceAliases',
  'prepareStabilityFixtures',
  'updateOrderServed',
  'updateUserCredit',
  'addUser',
  'updateUserActive',
  ...
  , 'cancelGuestApplicationOperations'
  , 'updateGuestApplicationSchedulingSettings'
  , 'repairGuestApplicationOperationDuplicates'
